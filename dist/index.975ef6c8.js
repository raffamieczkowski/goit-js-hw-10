...
const fetchCountryData = (0, _lodashDebounceDefault.default)((searchValue)=>{
    ...
    fetch(url).then((response)=>{
        ...
        if (data.length > 1) data.forEach((country)=>{
...
},{"./css/styles.css":"1CY4s","lodash.debounce":"3JP5n","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1CY4s":[function() {},{}],"3JP5n":[function(require,module,exports) {
var global = arguments[3];
/**
